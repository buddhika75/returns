...
public class CoordinateController implements Serializable {
    ...
    @EJB
    private lk.gov.health.faces.CoordinateFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle2").getString("CoordinateCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle2").getString("CoordinateUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle2").getString("CoordinateDeleted"));
        if (!JsfUtil.isValidationFailed()) {
