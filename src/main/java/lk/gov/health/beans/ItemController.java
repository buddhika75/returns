...
public class ItemController implements Serializable {
    ...
    @EJB
    private lk.gov.health.faces.ItemFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/BundleItems").getString("ItemCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/BundleItems").getString("ItemUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/BundleItems").getString("ItemDeleted"));
        if (!JsfUtil.isValidationFailed()) {
